...
const ResetPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  bg-gradient-to-br from-blue-100 to-purple-400">
      ...
      />
      {!isemailsent &&
        <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg w-96 shadow-lg text-sm">
      ...
      {!isotpsubmited && isemailsent &&
        <form onSubmit={onSubmitOtp} className="bg-slate-900 p-8 rounded-lg w-96 shadow-lg text-sm">
          <h1 className="text-white text-2xl font-semibold text-center mb-4">
            Reset Password OTP
          </h1>
          <p className="text-center mb-6 text-indigo-300">
      ...
      {isotpsubmited && isemailsent &&
        <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg w-96 shadow-lg text-sm">
          <h1 className="text-white text-2xl font-semibold text-center mb-4">
            New Password
          </h1>
          <p className="text-center mb-6 text-indigo-300">
